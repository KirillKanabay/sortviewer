object SortDemoForm: TSortDemoForm
  ...
  object SubmitCountButton: TPanel
    ...
    ParentFont = False
    TabOrder = 0
    OnClick = SubmitCountButtonClick
    OnMouseLeave = SubmitCountButtonMouseLeave
    OnMouseMove = SubmitCountButtonMouseMove
  end
  object GenDataButton: TPanel
    ...
    ParentFont = False
    TabOrder = 1
    OnClick = GenDataButtonClick
    OnMouseLeave = GenDataButtonMouseLeave
  ...
  object SortDataButton: TPanel
    ...
    ParentFont = False
    TabOrder = 2
    OnClick = SortDataButtonClick
    OnMouseLeave = SortDataButtonMouseLeave
    OnMouseMove = SortDataButtonMouseMove
  end
  object CountDataEdit: TEdit
    ...
    TabOrder = 3
    Text = '10'
    OnChange = CountDataEditChange
    OnKeyDown = CountDataEditKeyDown
  end
